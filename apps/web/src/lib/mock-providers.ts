/**
 * Mock provider profiles indexed by ID (1-20).
...
export const MOCK_PROVIDER_MAP: Record<string, MockProviderDetail> = {
  '1': {
    ...
    memberSince: 'ม.ค. 2567', community: 'หมู่บ้านศรีนคร', communityId: '1', area: 'บางแค, กรุงเทพฯ',
  ...
  '2': {
    ...
    memberSince: 'มี.ค. 2566', community: 'หมู่บ้านศรีนคร', communityId: '1', area: 'บางแค, กรุงเทพฯ',
  ...
  '3': {
    ...
    memberSince: 'มิ.ย. 2567', community: 'คอนโด The Base', communityId: '2', area: 'ลาดพร้าว, กรุงเทพฯ',
  ...
  '4': {
    ...
    bio: 'บริษัทบริการทำความสะอาดมืออาชีพ ทีมงาน 20 คน ตรวจสอบประวัติแล้วทุกคน ใช้อุปกรณ์และน้ำยามาตรฐาน ISO ประสบการณ์ 10 ปี งาน 5,000+ ครั้ง',
    verified: true, online: true, trustScore: 96, rating: 4.7, reviews: 203, completedBookings: 1240,
    memberSince: 'ก.ค. 2565', community: 'คอนโด The Base', communityId: '2', area: 'ลาดพร้าว, กรุงเทพฯ',
    responseTime: '< 1 ชั่วโมง', category: 'งานบ้าน',
    badges: ['ยืนยันตัวตน', 'บริษัทจดทะเบียน', 'ISO Certified'],
  ...
  '5': {
    ...
    memberSince: 'ก.พ. 2568', community: 'ชุมชนเมืองทอง', communityId: '3', area: 'เมืองทอง, นนทบุรี',
  ...
  '6': {
    ...
    bio: 'ช่างทอผ้าลายเหนือ ประสบการณ์ 20 ปี ผ้าฝ้ายแท้ 100% สีธรรมชาติ ลวดลายไทยเอกลักษณ์ รับออเดอร์พิเศษและสั่งทำลายเฉพาะ ส่งทั่วประเทศและต่างประเทศ',
    verified: true, online: true, trustScore: 88, rating: 4.8, reviews: 56, completedBookings: 180,
    memberSince: 'ส.ค. 2566', community: 'เมืองเชียงใหม่ซิตี้', communityId: '6', area: 'เมือง, เชียงใหม่',
    responseTime: '< 2 ชั่วโมง', category: 'งานฝีมือ',
    badges: ['ยืนยันตัวตน', 'OTOP', 'งานหัตถกรรมไทย'],
  ...
  '7': {
    ...
    bio: 'ครูนวดแผนไทย ใบรับรองจากกรมการแพทย์แผนไทยและการแพทย์ทางเลือก ประสบการณ์ 8 ปี ลูกค้าประจำ 200+ คน มีอุปกรณ์และน้ำมันนวดอย่างดีครบ บริการถึงบ้าน',
    verified: true, online: true, trustScore: 97, rating: 4.9, reviews: 74, completedBookings: 310,
    memberSince: 'พ.ย. 2566', community: 'หมู่บ้านกรีนวิลล์', communityId: '4', area: 'บึงกุ่ม, กรุงเทพฯ',
    responseTime: '< 1 ชั่วโมง', category: 'สุขภาพ & ความงาม',
    badges: ['ยืนยันตัวตน', 'ใบรับรองจากกรมการแพทย์', 'Top Rated'],
  ...
  '8': {
    ...
    bio: 'เกษตรกรออร์แกนิคสวนผัก 2 ไร่ ปลูกมา 6 ปี ไม่ใช้สารเคมีทุกชนิด ผ่านการรับรอง Organic Thailand ตัดสดทุกเช้า จัดเซ็ตหมุนเวียนตามฤดูกาล',
    verified: false, online: false, trustScore: 80, rating: 4.7, reviews: 38, completedBookings: 145,
    memberSince: 'ม.ค. 2567', community: 'ชุมชนริมน้ำ', communityId: '5', area: 'ปทุมธานี',
    responseTime: '< 4 ชั่วโมง', category: 'เกษตรกรรม',
    badges: ['Organic Thailand Certified'],
  ...
  '9': {
    ...
    bio: 'นักออกแบบ Graphic Design มืออาชีพ ประสบการณ์ 7 ปี ผลงาน Portfolio 300+ งาน ลูกค้าทั่วไทย รับทั้งโลโก้ สื่อสิ่งพิมพ์ โซเชียล และ Brand Identity ครบวงจร',
    verified: true, online: true, trustScore: 90, rating: 4.8, reviews: 19, completedBookings: 58,
    memberSince: 'ก.ย. 2567', community: 'คอนโด The Base', communityId: '2', area: 'ลาดพร้าว, กรุงเทพฯ',
    responseTime: '< 2 ชั่วโมง', category: 'ฟรีแลนซ์',
    badges: ['ยืนยันตัวตน', 'Graphic Design Pro'],
  ...
  '10': {
    ...
    memberSince: 'เม.ย. 2568', community: 'ชุมชนเมืองทอง', communityId: '3', area: 'เมืองทอง, นนทบุรี',
  ...
  '11': {
    ...
    memberSince: 'ก.พ. 2567', community: 'หมู่บ้านศรีนคร', communityId: '1', area: 'บางแค, กรุงเทพฯ',
  ...
  '12': {
    ...
    bio: 'นักโภชนาการและเชฟอาหารสุขภาพ Nutrition Certificate รับรอง ทุกเมนูคำนวณแคลอรี่ครบถ้วน รองรับอาหารพิเศษ: คีโต ลดน้ำหนัก เบาหวาน ส่งทุกเช้าก่อน 8:00 น.',
    verified: true, online: false, trustScore: 94, rating: 4.9, reviews: 95, completedBookings: 267,
    memberSince: 'ต.ค. 2567', community: 'คอนโด The Base', communityId: '2', area: 'ลาดพร้าว, กรุงเทพฯ',
    responseTime: '< 1 ชั่วโมง', category: 'อาหารและเครื่องดื่ม',
    badges: ['ยืนยันตัวตน', 'Nutrition Certified', 'Top Provider'],
  ...
  '13': {
    ...
    memberSince: 'เม.ย. 2567', community: 'เมืองเชียงใหม่ซิตี้', communityId: '6', area: 'เมือง, เชียงใหม่',
    responseTime: '< 1 ชั่วโมง', category: 'อาหารและเครื่องดื่ม',
  ...
  '14': {
    ...
    bio: 'สปาระดับพรีเมียม ย่านนิมมานเฮมิน บรรยากาศล้านนา ใช้สมุนไพรท้องถิ่น ทีมบำบัดผ่านการรับรองระดับนานาชาติ บริการนวดหน้า สปาตัว ล้างผิว และแพ็กเกจคู่',
    verified: true, online: true, trustScore: 93, rating: 4.9, reviews: 112, completedBookings: 420,
    memberSince: 'ก.พ. 2566', community: 'นิมมานเฮมิน วิลเลจ', communityId: '7', area: 'นิมมานเฮมิน, เชียงใหม่',
    responseTime: '< 2 ชั่วโมง', category: 'สุขภาพ & ความงาม',
    badges: ['ยืนยันตัวตน', 'Premium Spa', 'International Certified'],
  ...
  '15': {
    ...
    memberSince: 'ก.ย. 2566', community: 'เมืองเชียงใหม่ซิตี้', communityId: '6', area: 'เมือง, เชียงใหม่',
  ...
  '16': {
    ...
    bio: 'ร้านอาหารทะเลสดริมทะเล ภูเก็ต วัตถุดิบสดจากชาวประมงโดยตรงทุกเช้า ปรุงตามสั่ง รสชาติต้นตำรับใต้แท้ๆ รับทำกล่องอาหารส่ง และจัดเลี้ยงงานกลุ่ม',
    verified: true, online: true, trustScore: 90, rating: 4.8, reviews: 89, completedBookings: 312,
    memberSince: 'ก.พ. 2567', community: 'ป่าตอง ซีไซด์', communityId: '8', area: 'ป่าตอง, ภูเก็ต',
    responseTime: '< 1 ชั่วโมง', category: 'อาหารและเครื่องดื่ม',
    badges: ['ยืนยันตัวตน', 'วัตถุดิบสดตรงประมง', 'รสชาติใต้แท้'],
    availableDays: [0,1,2,3,4,5,6], openTime: '10:00', closeTime: '21:00',
    listings: [
  ...
  '17': {
    ...
    bio: 'ครูสอนดำน้ำ PADI Instructor ประสบการณ์ 10 ปี สอนทั้ง Scuba Diving และ Snorkeling นักเรียนกว่า 500 คน บรรยากาศเป็นกันเอง อุปกรณ์มาตรฐานสากล ปลอดภัย 100%',
    verified: true, online: true, trustScore: 95, rating: 4.9, reviews: 78, completedBookings: 290,
    memberSince: 'พ.ย. 2565', community: 'ป่าตอง ซีไซด์', communityId: '8', area: 'ป่าตอง, ภูเก็ต',
    responseTime: '< 1 ชั่วโมง', category: 'กีฬา & ฟิตเนส',
    badges: ['ยืนยันตัวตน', 'PADI Instructor', 'Safety First'],
  ...
  '18': {
    ...
    memberSince: 'ม.ค. 2568', community: 'ขอนแก่น อัพทาวน์', communityId: '9', area: 'เมือง, ขอนแก่น',
    responseTime: '< 1 ชั่วโมง', category: 'อาหารและเครื่องดื่ม',
  ...
  '19': {
    ...
    memberSince: 'มิ.ย. 2567', community: 'เมืองเชียงใหม่ซิตี้', communityId: '6', area: 'เมือง, เชียงใหม่',
    responseTime: '< 2 ชั่วโมง', category: 'งานช่าง',
  ...
  '20': {
    ...
    memberSince: 'ก.ค. 2567', community: 'ชุมชนเมืองทอง', communityId: '3', area: 'บางใหญ่, นนทบุรี',
